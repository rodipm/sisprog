...
public:
	Assembler(){
		...
		mnemonic_table[0x01].name = "JZ"; mnemonic_table[0x01].size = 2; mnemonic_table[0x01].op = 0x1;
		mnemonic_table[0x02].name = "JN"; mnemonic_table[0x02].size = 2; mnemonic_table[0x02].op = 0x2;
		mnemonic_table[0x03].name = "CN"; mnemonic_table[0x03].size = 1; mnemonic_table[0x03].op = 0x3;
		mnemonic_table[0x04].name = "+" ; mnemonic_table[0x04].size = 2; mnemonic_table[0x04].op = 0x4;
		mnemonic_table[0x05].name = "-" ; mnemonic_table[0x05].size = 2; mnemonic_table[0x05].op = 0x5;
		mnemonic_table[0x06].name = "*" ; mnemonic_table[0x06].size = 2; mnemonic_table[0x06].op = 0x6;
		mnemonic_table[0x07].name = "/" ; mnemonic_table[0x07].size = 2; mnemonic_table[0x07].op = 0x7;
		mnemonic_table[0x08].name = "LD"; mnemonic_table[0x08].size = 2; mnemonic_table[0x08].op = 0x8;
		mnemonic_table[0x09].name = "MM"; mnemonic_table[0x09].size = 2; mnemonic_table[0x09].op = 0x9;
		mnemonic_table[0x0a].name = "SC"; mnemonic_table[0x0a].size = 2; mnemonic_table[0x0a].op = 0xa;
		mnemonic_table[0x0b].name = "OS"; mnemonic_table[0x0b].size = 1; mnemonic_table[0x0b].op = 0xb;
		mnemonic_table[0x0c].name = "IO"; mnemonic_table[0x0c].size = 1; mnemonic_table[0x0c].op = 0xc;
	}
